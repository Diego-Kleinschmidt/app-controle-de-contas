  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-8 bg-zinc-50 px-6 py-16 dark:bg-zinc-950">
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <img src="/icone.png" alt="" className="h-16 w-16 object-contain" />
        ...
        <label className="flex flex-col gap-1">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 pr-11 text-zinc-900 outline-none focus:border-zinc-500 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
            />
            <button
              type="button"
